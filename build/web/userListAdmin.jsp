                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <c:if test="${not (empty index or index eq 1)}"> 
                                <li class="page-item">
                                    <a class="page-link" href="userManage?index=${index - 1}">Previous</a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" end="${endPage}" var="i">
                                ...
                                <li class="page-item ${activeClass}">
                                    <a class="page-link" href="userManage?index=${i}">${i}</a>
                                </li>
                            </c:forEach>
                            ...
                            <c:if test="${index < endPage}">
                                <li class="page-item">
                                    <a class="page-link" href="userManage?index=${index + 1}">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </nav>
