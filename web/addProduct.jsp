                ...
                <div class="container bg-white">
                    <div class="row px-5">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row-3">
                                        <div style="height: 280px;" class="border-dotted p-5 d-flex flex-column box-input-image w-90 position-relative justify-content-center">
                                            ...
                                            <input type="file" accept="image/gif, image/jpeg, image/png" onchange="previewImage(event)" class="form-control w-100 h-100 position-absolute top-0 start-0" style="z-index: 100; opacity: 0;" name="image" placeholder="Enter photo" required>
                                ...
                                <div class="text-center">
                                    <div class="row d-flex align-items-center mt-5">
                                        ...
                                        <div class="col-md-10 insert-product-input">
                                            <input type="text" id="product-name" name="productName" class="rounded-sm border w-100 fs-3 py-4 px-3" placeholder="Product name" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" d-flex align-items-center mt-5">
                                        <div class="col-md-2 text-end px-3">
                                            <label class="fs-4" for="product-type">Brand</label>
                                        </div>
                                        <div class="w-100">
                                            <select class="form-select py-3 fs-3" name="brandID" aria-label="Default select example">
                                    ...
                                    <div class="row d-flex align-items-center mt-5">
                                        ...
                                        <div class="col-md-10 insert-product-input">
                                            <input type="text" id="product-name" name="productPrice" class="rounded-sm border w-100 fs-3 py-4 px-3" placeholder="" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row d-flex align-items-center mt-5">
                                        ...
                                        <div class="col-md-10 insert-product-input">
                                            <input type="number" id="product-name" name="quantity" class="rounded-sm border w-100 fs-3 py-4 px-3" placeholder="" required />
                                        </div>
                                    </div>
                        ...
                        <div class="button-container">
                            <button type="submit" class="px-5 py-3 bg-success text-white border-0 fs-3 rounded-md">Insert</button>
                            <button class="ms-5 px-5 py-3 bg-danger text-white border-0 fs-3 rounded-md"><a href="productList.html" style="color: white">Cancel</a></button>
                        </div>
                    </div>
            </section>
        </form>
