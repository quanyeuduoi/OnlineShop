                                ...
                                <c:forEach var="product" items="${productList}">
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell" style="width: 10%;">
                                            ...
                                            <a href="deleteProduct?productID=${product.getProductID()}" class="me-4 text-info fw-bold fs-5">Update</a>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <c:if test="${not (empty index or index eq 1)}"> 
                                <li class="page-item">
                                    <a class="page-link" href="searchProduct?index=${index-1}&productName=${productName}">Previous</a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" end="${endPage}" var="i">
                                ...
                                <li class="page-item ${activeClass}">
                                    <a class="page-link" href="searchProduct?index=${i}&productName=${productName}">${i}</a>
                                </li>
                            </c:forEach>
                            ...
                            <c:if test="${index < endPage}">
                                <li class="page-item">
                                    <a class="page-link" href="searchProduct?index=${index + 1}&productName=${productName}">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </nav>
