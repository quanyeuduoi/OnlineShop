        ...
        <section>
            <div class="row h-100">
                ...
                <div class="col-md-10 h-100 manage-product">
                    <h1 class="fw-bold my-4">User List</h1>
                    <div class="row mt-5 ">
                        <div class="col-4">
                            <form action="searchUser" method="GET"> <!-- Thay 'your_action_url' bằng URL của action bạn muốn gửi form đến -->
                                <div class="input-box">
                                    <div class="search-icon">
                                        <i class='bx bx-search'></i>
                                    </div>
                                    <div class="search-input">
                                        <input type="text" name="userEmail" placeholder="Search for user by email" aria-label="Example text with button addon">
                                    </div>
                        ...
                        <div class="col-4">
                            <button><a href="addUser" style="color: white">Add User</a></button>
                        </div>
                        ...
                        <table class="table table-striped">
                            <thead class="bg-weak">
                                <tr class="rounded-lg">
                                    ...
                                    <th scope="col" style="width: 15%;">Default Address</th>
                                    <th scope="col" style="width: 10%;">Default Phone</th>
                            ...
                            <tbody>
                                <c:forEach var="user" items="${userList}">
                                    <tr>
                                        <td style="width: 10%;">${user.getUserID()}</td> <!-- Tùy chỉnh kích thước của cột ID -->
                                        <td style="width: 10%;">${user.getUserName()}</td>
                                        <td style="width: 20%;">${user.getEmail()}</td> <!-- Tùy chỉnh kích thước của cột Name -->
                                        <td style="width: 15%;">${user.getPassword()}</td>
                                        <td style="width: 15%;">${user.getRole().getRoleName()}</td>
                                        <td style="width: 15%;"><span class="text-danger fw-bold manage-dis_text">10000</span> ${user.getDefaultAddress()}</td>
                                        <td style="width: 10%;">${user.getDefaultPhone()}</td>
                                        <td class="d-none d-md-table-cell" style="width: 10%;">
                                            <a href="updateUser?userEmail=${user.getEmail()}" class="me-4 text-info fw-bold fs-5">Update</a>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <c:if test="${not (empty index or index eq 1)}"> 
                                <li class="page-item">
                                    <a class="page-link" href="searchUser?index=${index - 1}&email=${email}">Previous</a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" end="${endPage}" var="i">
                                ...
                                <li class="page-item ${activeClass}">
                                    <a class="page-link" href="searchUser?index=${i}&email=${email}">${i}</a>
                                </li>
                            </c:forEach>
                            ...
                            <c:if test="${index < endPage}">
                                <li class="page-item">
                                    <a class="page-link" href="searchUser?index=${index + 1}&email=${email}">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </nav>
