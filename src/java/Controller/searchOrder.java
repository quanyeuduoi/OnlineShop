...
public class searchOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Order> orderList = OrderDAO.INSTANCE.searchOrderByEmailPage(email, index);
        totalOrder = OrderDAO.INSTANCE.getTotalOrderByEmail(email);
        ...
        requestDispatcher = request.getRequestDispatcher("orderListSearchAdmin.jsp");
