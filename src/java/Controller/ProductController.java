...
public class ProductController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Product> productList = ProductDAO.INSTANCE.getListByIndexPage(index);
        
        int totalProduct = ProductDAO.INSTANCE.getTotalProduct();
        int endPage = totalProduct / 9;
        if (totalProduct % 9 != 0){
        ...
        ;
        requestDispatcher = request.getRequestDispatcher("productListAdmin.jsp");
