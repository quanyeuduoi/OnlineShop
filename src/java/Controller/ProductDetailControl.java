 ...
 * @author Admin
 */
@WebServlet(name="ProductDetailControl", urlPatterns={"/viewDetail"})
public class ProductDetailControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Review> reviewList = ReviewDAO.INSTANCE.getReviewByProductID(productID);
        request.setAttribute("reviewList", reviewList);
        request.setAttribute("product", product);
        RequestDispatcher requestDispatcher;
        requestDispatcher = request.getRequestDispatcher("productDetail.jsp");
