...
public class userManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<User> userList = UserDAO.INSTANCE.getUserByIndex(index);
        int totalUser = UserDAO.INSTANCE.getTotalUser();
        ArrayList<Role> roleList = RoleDAO.INSTANCE.getAllRole();
        int endPage = totalUser / 9;
        if (totalUser % 9 != 0) {
        ...
        requestDispatcher = request.getRequestDispatcher("userListAdmin.jsp");
