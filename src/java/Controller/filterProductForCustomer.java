 ...
 * @author Admin
 */
@WebServlet(name="filterProductForCustomer", urlPatterns={"/filterForCustomer"})
public class filterProductForCustomer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet filterProductForCustomer</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet filterProductForCustomer at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        requestDispatcher = request.getRequestDispatcher("productListFilter.jsp");
