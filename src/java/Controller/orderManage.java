...
public class orderManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Order> orderList = OrderDAO.INSTANCE.getListOrderByIndexPage(index);
       

        int totalOrder = OrderDAO.INSTANCE.getTotalOrder();
        
        int endPage = totalOrder / 9;
        if (totalOrder % 9 != 0) {
        ...
        ;
        requestDispatcher = request.getRequestDispatcher("orderListAdmin.jsp");
